                ...
                </div>
                {
                    listUsers?.map((current, i) => (
                        <p key={i}>
                            ...
                            <button onClick={() => deleteUser(current.id)}>Delete</button>
                        </p>
                    ))
                }
            </div>
...
async function deleteUser(userId: string) {
    try {
        ...
        const todosQuery = query(collection(firebaseDB, "todos"), where("userRef", "==", userRef));
        ...
        console.log('Todo deleted with ID:', userId);
    } catch (e) {
...
async function addTodo(todo: string, userId: string) {
    try {
        const userRef = doc(firebaseDB, "users", userId);
        ...
        console.log("Document written with ID: ", docRef.id, userRef.id);
